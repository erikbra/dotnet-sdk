...
public class TargetsTests
{
    ...
    public void CanDeferContainerAppCommand(
        ...
        string prop,
        bool value,
        params string[] expectedAppCommand)
    {
        ...
        }, projectName: $"{nameof(CanDeferContainerAppCommand)}_{prop}_{value}_{string.Join("_", expectedAppCommand)}");
        ...
        computedAppCommand.Should().BeEquivalentTo(expectedAppCommand);
    }
